...
results <- read.csv2("D:\\A3\\BIGDATA\\ProjetCHU\\ProjetCHU\\CSVrequetes\\TotalConsultPeriode.csv", header=TRUE, sep=";")
...
ggsave("D:\\A3\\BIGDATA\\ProjetCHU\\ProjetCHU\\GraphsR\\TotalConsultPeriode.png")